# Problema de Negocio - Prever os votos em republicanos e democratas (variável Class)
...
# which(is.na(HouseVotes84[,2]) & HouseVotes84$Class == 'democrat',arr.ind = TRUE) - retorna o número da linha na qual o valor é  'NA' na coluna especificada
...
round(dim(trainHouseVotes84)[1]/dim(HouseVotes84)[1],2)

testHouseVotes84 <- HouseVotes84[HouseVotes84$train == 0, -trainColNum]
round(dim(testHouseVotes84)[1]/dim(HouseVotes84)[1],2)

# Invocando o método NaiveBayes
install.packages("e1071")
library(e1071)

# Passo 1 - Crie o modelo NaiveBayes
...
# Repetindo o processo de Traino e Teste N vezes com amostras diferentes 
...
# Os resultados das execuções estão bem próximos, entre 0.89 (Q1) e 0.92 (Q3), 
